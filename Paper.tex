...
In the future, it would be nice to develop tighter theoretical bounds on our modified learning algorithm, and particulary to develop an improved bound on the adaptive $p$ algorithm.  It is possible that such a bound would lead to a more informed decision on how to change $p$ in the algorithm to minimize mistakes.  Finally, it would be worthwhile to explore other online learning algorithms and possible other features that might improve predictive performance.
