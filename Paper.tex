...
Finally, it would be worthwhile to explore other online learning algorithms and possible other features that might improve predictive performance. Considering a wider variety of text classification models would probably produce better results, and the limited time to develop this tool compromised our ability to develop and play around with some of these models. Nevertheless that is a huge body of work in and of itself.
